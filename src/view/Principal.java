...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		btnUsuarios.setBounds(56, 86, 128, 128);
		...
		lblNewLabel_4.setIcon(new ImageIcon(Principal.class.getResource("/img/carpequeno.png")));
		lblNewLabel_4.setBounds(710, 436, 72, 43);
