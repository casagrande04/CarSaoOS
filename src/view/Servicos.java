...
public class Servicos extends JDialog {
	...
	public Servicos() {
		setTitle("Serviços");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Servicos.class.getResource("/img/car.png")));
		...
		txtValor.setBounds(218, 247, 103, 20);
		...
		btnAdicionar.setBounds(108, 293, 46, 57);
		...
		btnEditar.setBounds(241, 293, 53, 57);
		...
		btnExcluir.setBounds(373, 293, 53, 57);
		...
		btnBuscar.setBounds(248, 44, 46, 41);
		...
		btnNewButton.setBounds(373, 162, 46, 41);
		getContentPane().add(btnNewButton);
		getRootPane().setDefaultButton(btnBuscar);

		JPanel panel = new JPanel();
		panel.setBorder(new TitledBorder(null, "Cliente:", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel.setBounds(373, 60, 159, 73);
		...
		btnOS.setBounds(410, 228, 122, 23);
		...
		label.setBounds(0, 0, 586, 397);
		getContentPane().add(label);

		fundo = new JLabel("");
		fundo.setIcon(new ImageIcon(Servicos.class.getResource("/img/serv.png")));
