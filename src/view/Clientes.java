...
public class Clientes extends JDialog {
	...
	public Clientes() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Clientes.class.getResource("/img/car.png")));
		setTitle("Cadastro de Cliente");
		setBounds(100, 100, 628, 549);
		...
		txtNome.setBounds(128, 97, 274, 20);
		...
		btnAdicionar.setBounds(166, 471, 63, 41);
		...
		btnEditar.setBounds(261, 468, 57, 47);
		...
		btnExcluir.setBounds(351, 462, 55, 58);
		...
		btnBuscarCEP.setBounds(287, 229, 115, 23);
		...
		txtContato.setBounds(128, 187, 274, 20);
		getContentPane().add(txtContato);

		lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setBorder(new LineBorder(new Color(0, 0, 0), 4));
		lblNewLabel_3.setIcon(new ImageIcon(Clientes.class.getResource("/img/maosss.png")));
		lblNewLabel_3.setBounds(513, 0, 271, 564);
